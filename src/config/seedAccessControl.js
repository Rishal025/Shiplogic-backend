...
const SHIPMENT_PERMISSION_TEMPLATES = [
  ...
  { key: 'shipment.tab.shipment_tracker_split.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'shipment_tracker_split', type: 'action', action: 'edit', label: 'Edit Shipment Tracker', sortOrder: 115 },
  ...
  { key: 'shipment.tab.bl_details.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'bl_details', type: 'action', action: 'edit', label: 'Edit BL Details', sortOrder: 135 },
  ...
  { key: 'shipment.tab.document_tracker.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'document_tracker', type: 'action', action: 'edit', label: 'Edit Document Tracker', sortOrder: 145 },
  ...
  { key: 'shipment.tab.port_customs.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'port_customs', type: 'action', action: 'edit', label: 'Edit Port & Customs', sortOrder: 155 },
  ...
  { key: 'shipment.tab.storage_arrival.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'storage_arrival', type: 'action', action: 'edit', label: 'Edit Storage & Arrival', sortOrder: 165 },
  ...
  { key: 'shipment.tab.quality.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'quality', type: 'action', action: 'edit', label: 'Edit Quality', sortOrder: 175 },
  ...
  { key: 'shipment.tab.payment_costing.edit', resource: 'shipment', screen: 'shipment_tracker', tab: 'payment_costing', type: 'action', action: 'edit', label: 'Edit Payment & Costing', sortOrder: 185 },
...
const DEFAULT_ROLE_PERMISSION_MAP = {
  ...
  Logistic: [
    ...
    'shipment.tab.storage_arrival.edit',
  ],
  FAS: [
    'menu.dashboard.view',
    'menu.shipments.view',
    ...
    'shipment.tab.payment_costing.edit',
